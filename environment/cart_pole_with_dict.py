...
class CartPoleWithDict(gym.Env):
    """
    Description:
    ...
    Observation:
        ...
        Key     Description Shape           Min       Max

        Cart    Position, and velocity       (2,)       [-4.800, -Inf]   [4.800, Inf]
        Pole    Angle and angular momentum   (2,)       [-0.418, -Inf]   [0.418, Inf]
    ...
    def __init__(self, env_config:Dict): # This part is added.
        self.gravity = 9.8
        self.masscart = 1.0
        self.masspole = 0.1
    ...
    def step(self, action):
        ...
        x, x_dot = self.state['cart']
        theta, theta_dot = self.state['pole']
    ...
    def render(self, mode="human"):
        ...
        cartx = self.state['cart'][0] * scale + screen_width / 2.0  # MIDDLE OF CART
        self.carttrans.set_translation(cartx, carty)
        self.poletrans.set_rotation(-self.state['pole'][0])
